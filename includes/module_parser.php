...
class knParser{
	...
	function parse(){
		...
		switch($this->type){
			...
			case 'text/html': 
				$this->output = '<script language="javascript" type="text/javascript" src="js/jquery-1.11.2.min.js">' . 
						'</script><script language="javascript" type="text/javascript" src="js/dom.min.js?key=' . 
						$this->stdEncoder->getCurrentKey() . '">' .
						'</script>' . $this->source ;
				break;
			default:{
